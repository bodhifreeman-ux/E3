...
# No sudo required - assumes dependencies already installed
...
# Skip MKL (x86-only) - PyTorch will use OpenBLAS on ARM64
...
echo "  source $BUILD_DIR/pytorch-venv/bin/activate"
